let response = window.prompt("Are you ready to play the game?");

if (response !== "yes") {
    alert("Thanks. Please play again sometime.")
} else if (response === "yes") {
    alert("You are in a dark, dingy, and humid cave searching for the lost treasure of Captain Chingadera. You are disoriented, lost, hungry and extremely thirsty. You see a speck of light in the distance ahead of you, something shimmering to your right, and the sound of running water to your left. Your back is against the wall.");

    let firstAnswer = window.prompt("Which direction would you like to head (please enter forward, left, or right).");
    ...
    let secondAnswer = parseInt(window.prompt("Please rate the game between 1 and 10."));

    if (secondAnswer < 1 || secondAnswer > 10) {
